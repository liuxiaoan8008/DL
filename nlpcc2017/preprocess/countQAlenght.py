...
CAL = open(fenci_path+'lpcc-iccpol-2016-answer.dbqa.fenci.training-data')
LL=CAL
linelenght1={}
linelenght2={}
for lline in LL :
...
len1=''
len2=''
with open(statistic_path+'AA_all_lenght.txt','w') as wo1:
    for llen in linelenght1:
        len1=len1+str(llen)+' : '+str(linelenght1[llen])+'\n'
    wo1.write(len1)
with open(statistic_path+'AA_no_symbol_lenght.txt','w') as wo2:
