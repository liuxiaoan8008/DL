...
def inference(q_data,a_data,word2vec_dimension,
    ...
    with tf.name_scope('MLP_1'):
        ...
        W_fc1 = weight_variable([50 * word2vec_dimension * conv1_filter_number*2, fc_1_w*conv1_filter_number])
        b_fc1 = bias_variable([fc_1_w*conv1_filter_number])
    ...
    with tf.name_scope('MLP_2'):
        W_fc2 = weight_variable([fc_1_w*conv1_filter_number, fc_2_w * conv1_filter_number])
        b_fc2 = bias_variable([fc_2_w * conv1_filter_number])
    ...
    with tf.name_scope('softmax'):
        W_fc3 = weight_variable([fc_2_w * conv1_filter_number, 1])
